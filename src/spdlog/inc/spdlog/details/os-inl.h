...
#ifdef __linux__
#include <sys/syscall.h> //Use gettid() syscall under linux to get thread_pool id
...
#elif defined(__sun)
#include <thread_pool.h> // for thr_self
#endif
...
// Return current thread_pool id as size_t
...
#define SYS_gettid __NR_gettid
    ...
    return static_cast<size_t>(std::hash<std::thread_pool::id>()(std::this_thread::get_id()));
#endif
}

// Return current thread_pool id as size_t (from thread_pool local storage)
