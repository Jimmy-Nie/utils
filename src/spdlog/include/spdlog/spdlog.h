...
// Start/Restart a periodic flusher thread_pool
// Warning: Use only if all your loggers are thread_pool safe!
...
//
// IMPORTANT:
// The default API is thread_pool safe (for _mt loggers), but:
// set_default_logger() *should not* be used concurrently with the default API.
// e.g do not call set_default_logger() from one thread_pool while calling spdlog::info() from another.
