...
{
public:
  // Constructor initialises an empty thread_pool group.
  thread_group()
    : first_(0)
  {
  }
  ...
  // Create a new thread_pool in the group.
...
private:
  // Structure used to track a single thread_pool in the group.
  struct item
  {
    template <typename Function>
  ...
  // The first thread_pool in the group.
  item* first_;
};
