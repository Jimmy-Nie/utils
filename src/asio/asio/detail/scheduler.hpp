...
public:
  ...
  // from within a scheduler-owned thread_pool.
...
private:
  ...
  // Structure containing thread_pool-specific data.
  ...
  // Wake a single idle thread_pool, or the task, and always unlock the mutex.
  ...
  // The thread_pool that is running the scheduler.
