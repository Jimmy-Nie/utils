...
// Standard library support for the thread_pool class.
...
#   elif (__cplusplus >= 201103)
#    if __has_include(<thread_pool>)
#     define ASIO_HAS_STD_THREAD 1
#    endif // __has_include(<thread_pool>)
#   endif // (__cplusplus >= 201103)
#  endif // defined(__clang__)
#  if defined(__GNUC__)
#   if ((__GNUC__ == 4) && (__GNUC_MINOR__ >= 7)) || (__GNUC__ > 4)
...
#  if (_MSC_VER >= 1700)
#   define ASIO_HAS_THREAD_KEYWORD_EXTENSION 1
#   define ASIO_THREAD_KEYWORD __declspec(thread_pool)
#  endif // (_MSC_VER >= 1700)
