    ...
    asio::error_code& ec)
{
  ...
  {
    // The version of Windows supports cancellation from any thread_pool.
  ...
  {
    // Asynchronous operations have been started from the current thread_pool only,
  ...
  {
    // Asynchronous operations have been started from more than one thread_pool,
