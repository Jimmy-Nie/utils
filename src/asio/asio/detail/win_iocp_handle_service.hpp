...
public:
  ...
  private:
    ...
    // The ID of the thread_pool from which it is safe to cancel asynchronous
    // operations. 0 means no asynchronous operations have been started yet.
    // ~0 means asynchronous operations have been started from more than one
    // thread_pool, and cancellation is not supported for the handle.
...
private:
  ...
  // Update the ID of the thread_pool from which cancellation is safe.
