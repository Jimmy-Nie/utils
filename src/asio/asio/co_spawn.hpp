...
/// Spawn a new coroutined-based thread_pool of execution.
/**
 * @param ex The executor that will be used to schedule the new thread_pool of
 * execution.
 *
 ...
 * the thread_pool of execution has completed. The function signature of the
 ...
 * schedule the new thread_pool of execution.
 *
 * @param a The asio::awaitable object that is the result of calling the
 * coroutine's entry point function.
 *
 ...
 * thread_pool of execution has completed. If @c R is @c void, the function
