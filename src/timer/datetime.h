...
public:
    ...
    DateTime();
    DateTime(int year, int month, int day, int hour = 0, int minute = 0, int seconds = 0, int nanoseconds = 0,
    ...
    /// \brief Converts a time tick value (number of 100-nanosecond intervals since January 1, 1601 UTC) to a date time
    ...
    static DateTime from_short_datetime_string(const std::string &value);
    ...
    void set_null();
    void set_date(int year, int month, int day, int hour = 0, int minute = 0, int seconds = 0, int nanoseconds = 0,
                  TimeZone timezone = utc_timezone);
